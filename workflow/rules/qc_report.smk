...
rule qc_report_count:
    ...
    input:
        ...
        statistics_all_merged="results/experiments/{project}/statistic/statistic_assigned_counts_merged.{assignment}.{config}.tsv",
        statistics_all_single="results/experiments/{project}/statistic/statistic_assigned_counts_single.{assignment}.{config}.tsv",
