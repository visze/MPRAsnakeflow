...
rule qc_report_count:
    ...
    input:
        ...
        rna_oligo_coor_min_thre_plot="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.RNA.pairwise.minThreshold.png",
        rna_oligo_coor_plot="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.RNA.pairwise.png",
        dna_oligo_coor_plot="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.DNA.pairwise.png",
        ratio_oligo_coor_plot="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.Ratio.pairwise.png",
        ratio_oligo_min_thre_plot="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.Ratio.pairwise.minThreshold.png",
        statistics_all_merged="results/experiments/{project}/statistic/statistic_assigned_counts_merged_{assignment}.{config}.tsv",
        statistics_all_single="results/experiments/{project}/statistic/statistic_assigned_counts_single_{assignment}.{config}.tsv",
        statistics_all_oligo_cor_all="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.correlation.tsv",
        statistics_all_oligo_cor_thresh="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.correlation.minThreshold.tsv",
        counts_per_oligo="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.barcodesPerInsert.png",
        counts_per_bc_dna="results/experiments/{project}/statistic/barcode/assigned_counts/{assignment}/{condition}.{config}.DNA.perBarcode.png",
        counts_per_bc_rna="results/experiments/{project}/statistic/barcode/assigned_counts/{assignment}/{condition}.{config}.RNA.perBarcode.png",
        activity_all="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.group_barcodesPerInsert_box.png",
        activity_thresh="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.group_barcodesPerInsert_box_minThreshold.png",
        dna_over_rna="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.dna_vs_rna.png",
        dna_over_rna_thresh="results/experiments/{project}/statistic/assigned_counts/{assignment}/{config}/{condition}.dna_vs_rna_minThreshold.png",
